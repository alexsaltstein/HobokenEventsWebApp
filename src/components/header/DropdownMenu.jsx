...
export default function DropdownMenu({ effect, authed }) {
    return (
        <>
            <div className="relative text-left z-10 md:hidden">
                <div className={`absolute transition-all duration-500 ${effect ? 'top-9' : '-top-60'} left-0 mt-5 w-full origin-top-left bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1" id='menu'>
