...
export const EventList = ({ title, url }) => {
  ...
  if (loading) {
    return (
      <div role="status" class="relative top-24 space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center w-10/12 mx-auto">
        <div class="flex justify-center items-center w-full h-48 bg-gray-300 rounded sm:w-96">
  ...
  if (!eventData || eventData.length === 0) {
    return (
    <div className="relative top-40 w-screen text-input-label-gray text-center font-semibold text-xl min-h-full">
