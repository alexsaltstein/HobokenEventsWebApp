                ...
                <div>
                  <div className="mb-10">
                    ...
                    <p className="text-gray-500">
                      ...
                      for deals so we can still be social and not break the
                      bank.
                    </p>
                    <br />
                    <p className="text-gray-500">
                      Hudson Happs is about putting all the deals of the local
                      Hudson County and NYC area all in one place so you can
                      spend less time scouring the web and more time spending
                      time with friends or just saving a couple bucks!
                    </p>
                  </div>
                  <div className="mb-10">
                    <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900">
                  ...
                  <div className="mb-10">
                    ...
                    <p className="text-gray-500">
                      ...
                      , click contact us, or dm us on any socials! Feedback is
                      the best way you can let us know what you’d want us to
